...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    {
      question: "👥 Кому подойдут мои услуги?",
        ...
        <div className="max-w-4xl mx-auto">
                      ...
                      {index === faqs.length - 1 && (
                        <div className="mt-4 p-4 bg-primary/5 border border-primary/20 rounded-lg">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Напишите мне сейчас и получите персональную консультацию + расчёт стоимости бесплатно!
                          </p>
                        </div>
                      )}
                    </div>
          ...
          <div className="fade-in-up text-center mt-12 p-8 gradient-subtle rounded-2xl">
            ...
            <p className="text-muted-foreground mb-6">
              Напишите мне лично — отвечу в течение часа и рассчитаю стоимость вашего проекта
            </p>
            <Button 
              onClick={handleContactClick}
              size="lg"
